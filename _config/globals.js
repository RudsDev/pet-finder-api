...
global.contentRoot = path.join(global.appRoot, 'galeria')
global.callback200 = require('./http-status-code').http200
global.callback201 = require('./http-status-code').http201
global.callback202 = require('./http-status-code').http202
